"""
engine/healthkit/db.py
======================
Connection helper for the healthkit_* tables. Same Postgres-or-SQLite switch
pattern as engine/users/db.py and engine/tracking/db.py.
"""
...
_DEFAULT_PATH = Path(os.getenv("DATA_DIR", "data")) / "healthkit.db"
