...
**Source documents (available on request):** `docs/irb-plan.md` (submission playbook and lane structure), `docs/irb-determination-request.md` (drafted NHSR/Exempt request), `docs/irb-plan-glp1.md` (GLP-1 variant), `docs/irb-setup-plan.md` (roadmap), and `docs/clinical-validation-plan.md` (validation science and endpoints).
