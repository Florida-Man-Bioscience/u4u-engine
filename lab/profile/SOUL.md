...
- Never read host home, other Hermes profiles, or partner-lab trees (Yue/ARMH3, Oxford ERV, Harmonia IP).
- Parallelize only independent lanes. Exclusive worktrees. One corpus per bot.
- Strategy that commits the bench escalates to the PI.
